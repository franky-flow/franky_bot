/*********************************************************************
 *  ROSArduinoMega - TEST FASE 2
 *  
 *  Comunicación Serial + Control de Motores L298N
 *  
 *  Hardware: Arduino Mega 2560 Rev3 + L298N Motor Driver
 *  
 *  Este archivo contiene la implementación de FASE 1 + FASE 2 para
 *  poder probar la comunicación serial y el control de motores.
 *********************************************************************/
...
void setup() {
  ...
  // Mensaje de inicio
  Serial.println("ROSArduinoMega TEST FASE 2 - Ready!");
}
